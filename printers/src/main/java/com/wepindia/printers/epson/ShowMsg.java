package com.wepindia.printers.epson;
...
public class ShowMsg {
    ...
    public static void showConnectionError(Exception e, String method, Context context) {
        String msg = "";

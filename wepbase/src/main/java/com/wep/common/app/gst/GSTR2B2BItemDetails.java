...
public class GSTR2B2BItemDetails {
    ...
    private GSTR2B2BItemDetails() {
    }

    public GSTR2B2BItemDetails(String ty, String hsn_sc, double txval, double irt, double imat, double crt, double camt, double srt, double samt, String elg) {
        this.ty = ty;
        this.hsn_sc = hsn_sc;
        this.txval = txval;
        this.irt = irt;

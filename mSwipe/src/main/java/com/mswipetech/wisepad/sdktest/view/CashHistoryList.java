...
public class CashHistoryList extends BaseTitleActivity {
    ...
    public void ShowHistoryData(String xmlHistoryData) {
        ...
        if (totalRecord == 0) {
            ...
            if (errMsg.length() == 0 && listData.size()>0) {
                ...
                final Dialog dialog = Constants.showDialog(CashHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, "Unable to show the history data, please contact support.", "1");
                 Button yes = (Button) dialog.findViewById(R.id.bmessageDialogYes);
                 yes.setOnClickListener(new OnClickListener() {
    ...
    public void getCashHistory() {
        	...
        	MswipeWisepadController wisepadController = new MswipeWisepadController(CashHistoryList.this, AppPrefrences.getGateWayEnv(),null);
            wisepadController.getCashHistory(refreshHandler,Constants.Reference_Id, Constants.Session_Tokeniser);
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            try
            {
                ...
                if (status.equalsIgnoreCase("false")) {
                    ...
                    Constants.showDialog(CashHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, ErrMsg, 1);
                ...
                Constants.showDialog(CashHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, Constants.CARDHISTORYLIST_ERROR_PROCESSIING_DATA, 1);

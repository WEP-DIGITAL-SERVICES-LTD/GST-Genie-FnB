...
public class CardSummary extends BaseTitleActivity
{
    ...
    public void getCardSummary() {
    	...
    	MswipeWisepadController wisepadController = new MswipeWisepadController(CardSummary.this, AppPrefrences.getGateWayEnv(),null);
        wisepadController.getCardSummary(CardSummaryHandler, Constants.Reference_Id, Constants.Session_Tokeniser, mSelectedDate);

        mProgressActivity = null;
        mProgressActivity = new CustomProgressDialog(CardSummary.this, "Fetching Summary...");
    ...
    public Handler CardSummaryHandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            try
            {
                ...
                if (status.equalsIgnoreCase("false")) {
                    ...
                    Constants.showDialog(CardSummary.this, "card sale summary", ErrMsg, 1);

                }else{

                	 Intent intent = new Intent(CardSummary.this, CardSummaryDetails.class);
                     intent.putExtra("TotalAmt", strTags[2][1]);
                     intent.putExtra("VoidAmt", strTags[3][1]);
                     intent.putExtra("NoofSwipes", strTags[4][1]);
                     intent.putExtra("NoofVoids", strTags[5][1]);
                ...
                Constants.showDialog(CardSummary.this, "card sale summary", "The sale summary was not processed successfully please try again", 1);

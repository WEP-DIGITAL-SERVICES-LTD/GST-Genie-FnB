...
public class CashHistory extends BaseTitleActivity {
    public final static String log_tab = "CashHistory=>";
    ...
    private void initViews() {
        ...
        ((LinearLayout) findViewById(R.id.lsttrxstatus_LNR_Cheque_No)).setVisibility(View.GONE);
        ...
        if (listData.size() == 0) {
            ...
            final Dialog dialog = Constants.showDialog(CashHistory.this, "cash history", 

...
public class CashSummary extends BaseTitleActivity
{
    ...
    private void initViews() {
        ...
        //relCardSummaryData = (RelativeLayout) findViewById(R.id.cardsumary_REL_cardsumarydata);
        //relCardSummaryData.setVisibility(View.INVISIBLE);
    ...
    public void getCashSummary() {
        ...
        wisepadController.getCashSummary(CashSummaryHandler, Constants.Reference_Id, Constants.Session_Tokeniser, mSelectedDate);
    ...
    public Handler CashSummaryHandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            String[][] strTags = new String[][]{{"status", ""}, {"ErrMsg", ""}, {"CashSaleAmount", ""}, {"CashSaleCount", ""}};
            ...
            try
            {
                ...
                if (status.equalsIgnoreCase("False")) {
                    ...
                    Constants.showDialog(CashSummary.this, "cash summary", ErrMsg, 1);

                }else{

                	 Intent intent = new Intent(CashSummary.this, CashSummaryDetails.class);
                     intent.putExtra("CashSaleAmount", strTags[2][1]);
                     intent.putExtra("CashSaleCount", strTags[3][1]);
                ...
                Constants.showDialog(CashSummary.this, "cash summary", "The cash summary was not processed successfully please try again", 1);

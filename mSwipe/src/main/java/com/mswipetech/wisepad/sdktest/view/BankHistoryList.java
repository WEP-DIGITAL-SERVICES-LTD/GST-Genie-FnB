...
public class BankHistoryList extends BaseTitleActivity {
    public final static String log_tab = "BankHistoryList=>";
    ...
    private void initViews() {
        ...
        lstHistory.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent intent = new Intent(BankHistoryList.this, BankHistory.class);
        ...
        mBtnRefresh.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = Constants.showDialog(BankHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG,
    ...
    public void ShowHistoryData(String xmlHistoryData) {
        ...
        if (totalRecord == 0) {
            ...
            if (errMsg.length() == 0 && listData.size()>0) {
                ...
                final Dialog dialog = Constants.showDialog(BankHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, "Unable to show the history data, please contact support.", "1");
                 Button yes = (Button) dialog.findViewById(R.id.bmessageDialogYes);
                 yes.setOnClickListener(new OnClickListener() {
                   ...
                   case XmlPullParser.START_TAG: {
                       if ("ResultElement".equalsIgnoreCase(parser.getName().trim())) {
                           ...
                           if (iDataTagIndex < strDataTags.length && strDataTags[iDataTagIndex].equals(xmlTag) ) {
                               ...
                               else if(iDataTagIndex ==5) historyData.ChequeNo=xmlText;
                               iDataTagIndex++;
    ...
    public void getCashHistory() {
        	...
        	MswipeWisepadController wisepadController = new MswipeWisepadController(BankHistoryList.this, AppPrefrences.getGateWayEnv(),null);
            wisepadController.getBankHistory(refreshHandler,Constants.Reference_Id, Constants.Session_Tokeniser);

            mProgressActivity = null;
            mProgressActivity = new CustomProgressDialog(BankHistoryList.this, "Fetching History...");
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            try
            {
                ...
                if (status.equalsIgnoreCase("false")) {
                    ...
                    Constants.showDialog(BankHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, ErrMsg, 1);
                ...
                Constants.showDialog(BankHistoryList.this, Constants.CARDHISTORYLIST_DIALOG_MSG, Constants.CARDHISTORYLIST_ERROR_PROCESSIING_DATA, 1);

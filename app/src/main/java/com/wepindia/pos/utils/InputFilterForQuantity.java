...
public class InputFilterForQuantity implements InputFilter {

    private double min, max;

    public InputFilterForQuantity(double min, double max) {
        this.min = min;
        this.max = max;
    }

    public InputFilterForQuantity(String min, String max) {

...
import com.wepindia.pos.views.InwardManagement.SupplierDetailsActivity;
                            ...
                            for(Supplier_Model supplier : SupplierList)
                            {
                                if(supplier.get_id()==SupplierCode )
                                {
                                    ...
                                    if(ll >0)
                                    {
                                        ...
                                        if(activityName.equalsIgnoreCase("com.wepindia.pos.views.InwardManagement.SupplierDetailsActivity"))
                                        {

...
public class TableBookingActivity_old extends WepBaseActivity {

    // Context object
    Context myContext;

    // DatabaseHandler object
    DatabaseHandler dbTableBooking = new DatabaseHandler(TableBookingActivity_old.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tablebooking_old);

...
public class BillingHomeDeliveryActivity extends WepPrinterBaseActivity implements TextWatcher, PrinterConnectionError,
    ...
    String linefeed = "", strJurisdictionsPrint = "";
    ...
    WepButton btnSplitBill, btnSaveKOT, btnPayBill, btnDeleteKOT,btnDeleteBill, btnDeliveryStatus, btnPrintKOT, btnPrintBill,
            btnClear, btnReprint, btn_ViewBill;
    TextView tvDate, tvSubTotal, tvIGSTValue, tvCGSTValue, tvSGSTValue, tvBillAmount, tvSubUdfValue, tvOthercharges,tvcessValue;
    ...
    private EditText etOnlineOrderNo;
    private TextView tvOnlineOrderNo;
...
//        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myContext = this;
        sharedPreferences = Preferences.getSharedPreferencesForPrint(BillingHomeDeliveryActivity.this); // getSharedPreferences("PrinterConfigurationActivity", Context.MODE_PRIVATE);
        ...
        try {
            ...
            if (jBillingMode == 4) {
                ...
                etOnlineOrderNo.setVisibility(View.VISIBLE);
                tvOnlineOrderNo.setVisibility(View.VISIBLE);
            }
  ...
  /*  private void LoadDepartments(Cursor cursor) {
   ...
   /* private void LoadCategories(Cursor crsrCateg) {
    ...
    private void AddItemToOrderTable(Cursor crsrItem)
    {
        ...
        String strQty = "0";
        double dRate = 0, dTaxPercent = 0, dDiscPercent = 0, dTaxAmt = 0, dIGSTAmt =0, dcessAmtPerUnit = 0,dDiscAmt = 0, dTempAmt = 0, dServiceTaxPercent = 0;
        double dServiceTaxAmt = 0;
        double dcessRate =0;
        double dCessAmount =0;
        double dCessAdditionalAmount =0;
                    ...
                    if (Row.getChildAt(0) != null)
                    {
                                ...
                                && ItemName.getText().toString().equalsIgnoreCase(crsrItem.getString(crsrItem.getColumnIndex(DatabaseHandler.KEY_ItemShortName))))
                        {
                            ...
                            else
                            {
                                ...
                                TextView tvAdditionalCessAmount = (TextView) Row.getChildAt(29);
                                TextView tvTotalCessAmt = (TextView) Row.getChildAt(30);
...
//                    tvAmount.setTextSize(11);
                    ...
                    rowItem.addView(tvAdditionalCessAmt);//29
                    rowItem.addView(tvTotCessAmount); //30
...
//                    tvcessAmt.setText(crsrBillItems.getString(crsrBillItems.getColumnIndex("cessAmount")));
                    ...
                    TextView tvcessAmtPerUnit = new TextView(myContext);
                    ...
                    TextView tvcessAmtAdditional = new TextView(myContext);
                    tvcessAmtAdditional.setText(String.format("%.2f", crsrBillItems.getDouble(crsrBillItems.getColumnIndex(DatabaseHandler.KEY_TotalAdditionalCessAmount))));
                    ...
                    TextView tvTotalCessAmount = new TextView(this);
                    ...
                    rowItem.addView(tvTaxableValue);//28
                    rowItem.addView(tvcessAmtAdditional);//29
                    rowItem.addView(tvTotalCessAmount);//30
...
//                    tvcessAmt.setText(String.format("%.2f", crsrBillItems.getDouble(crsrBillItems.getColumnIndex("cessAmount"))));
                    ...
                    rowItem.addView(tvOriginalRate); //27
                    rowItem.addView(tvTaxableValue);//28
                    rowItem.addView(tvcessAmtAdditional);//28
                    rowItem.addView(tvTotalCessAmount);//28
                                ...
                                if (!strMakeOrder.equalsIgnoreCase("YES") && !strMakeOrder.equalsIgnoreCase("")) {
                                    ...
                                    if (strBillNo != null && !strBillNo.equals("") && !strBillNo.equals("0")) {
                                        ...
                                        if (cursorBillInfo.moveToNext()) {
                                            ...
                                            tvOthercharges.setText(String.format("%.2f", cursorBillInfo.getDouble(cursorBillInfo.getColumnIndex("DeliveryCharge"))));
                                            ...
                                            if(pos!=null && custStateCode!=null && pos.trim().equalsIgnoreCase(custStateCode.trim())) // cgst+sgst
                                            {
                                                ...
                                                tvCGSTValue.setTextColor(Color.WHITE);
                                                tvSGSTValue.setTextColor(Color.WHITE);
                                                tvCGSTValue.setText(String.format("%.2f",cursorBillInfo.getDouble(cursorBillInfo.getColumnIndex("CGSTAmount"))));
                                                tvSGSTValue.setText(String.format("%.2f",cursorBillInfo.getDouble(cursorBillInfo.getColumnIndex("SGSTAmount"))));
                                            }else
                                            {
...
//                            askForConfig();
                        ...
                        String target = Preferences.getSharedPreferencesForPrint(BillingHomeDeliveryActivity.this).getString(prf, "--Select--");
...
//        if (isPrinterAvailable) {
            if (tblOrderItems.getChildCount() < 1) {
                ...
                if (!tvBillNumber.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    if(jBillingMode == 3) {
                        if(etOnlineOrderNo != null && !etOnlineOrderNo.getText().toString().isEmpty()) {
                            item.setStrOnlineOrderNo(etOnlineOrderNo.getText().toString());
                        }
                    }
                    item.setBillingMode(String.valueOf(jBillingMode));
...
//                            progressDialog.dismiss();
    ...
    public void KOTStatus(View view) {
        ...
        //intentDelivery.putExtra("DISCOUNT_AMOUNT", dblTotalDiscount);//spUser.getString("USER_NAME", "GHOST"));
    ...
    public String getPrinterName(String module) {
        return Preferences.getSharedPreferencesForPrint(BillingHomeDeliveryActivity.this).getString(module, "--Select--");
    }
...
//                    }
    ...
    private void sendInvoice(Customer customer, final String billAmount, final String billNo) {
        ...
        if (!isWifiConnected()) {
            Toast.makeText(BillingHomeDeliveryActivity.this, "Kindly connect to internet to share the bill.", Toast.LENGTH_LONG).show();
            return;
        }
...
//            etCustName.setText("");
            ...
            final AlertDialog.Builder alert = new AlertDialog.Builder(BillingHomeDeliveryActivity.this);
            ...
            btnSend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (etCustPhone.isEnabled() && etCustPhone.getText().toString().isEmpty()) {
                        ...
                        Toast.makeText(BillingHomeDeliveryActivity.this, "Sending....", Toast.LENGTH_SHORT).show();
                        alertDialog.dismiss();
                    } else {
                        Toast.makeText(BillingHomeDeliveryActivity.this, "Please select either SMS or email or both to share invoice details with the customer.", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
    ...
    private void send(String custName, String custPhoneNo, String custEmail, String billAmount, String billNo) {
        ...
        SendBillInfoToCustUtility smsUtility = new SendBillInfoToCustUtility(BillingHomeDeliveryActivity.this, "Invoice", Constants.message_email + firmName,messageContent, custPhoneNo, true, true, false,
                BillingHomeDeliveryActivity.this, custEmail, attachment, filename, firmName);
        smsUtility.sendBillInfo();
        Toast.makeText(BillingHomeDeliveryActivity.this, "Sharing Invoice...", Toast.LENGTH_SHORT).show();
    }

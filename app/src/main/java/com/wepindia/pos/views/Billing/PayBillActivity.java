...
public class PayBillActivity extends FragmentActivity implements FragmentLogin.OnLoginCompletedListener,PaymentResultListener {
    ...
    EditText edtTotalValue, edtRoundOff, edtPaid, edtCard, edtChange,
            edtPettyCash, edtDiscount, edtWallet, edtCoupon, edtTenderTotalValue, edtOtherCards;
...
//        dCard = edtCard.getText().toString().equalsIgnoreCase("") ? 0.00 : Double.parseDouble(edtCard.getText().toString());
            ...
            dWallet = edtWallet.getText().toString().equalsIgnoreCase("") ? 0.00 : Double.parseDouble(edtWallet.getText().toString());
            ...
            dTenderAmount = (dCash + dCard + dCoupon + dPettyCash + dWallet);
...
*/
    ...
    public Intent getSaveIntent(boolean isPrint){
        ...
        try{
            ...
            intentResult.putExtra(TENDER_CHANGE_VALUE,  Math.abs(Double.parseDouble(edtChange.getText().toString())));
                    ...
                    rowPayBill.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (String.valueOf(v.getTag()) == "TAG") {
                                ...
                                edtWallet.setText(VoucherValue.getText().toString());
                                PayBillDialog.dismiss();
                            }
                        }
                    });
